...
public interface ISysUserService {
	 ...
	 * @return
	 */
	List<SysUser> selectListByMap(Map<Object, Object> map);

	List<SysUser> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<SysUser> generateMyPageViewVO(Map<Object, Object> map);
}
