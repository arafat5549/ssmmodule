 ...
 *
 */
public interface ISysReUserAppService {
	 ...
	 * @return
	 */
	List<SysReUserApp> selectListByMap(Map<Object, Object> map);

	List<SysReUserApp> listPage(int offset,int limit,Map<Object, Object> map);
	...
	int insert(SysReUserApp record);

	int insertSelective(SysReUserApp record);
     ...
     * @return
     */
    MyPageView<SysReUserApp> generateMyPageViewVO(Map<Object, Object> map);
}
