...
public interface ISysRoleService {
	 ...
	 * @return
	 */
	List<SysRole> selectListByMap(Map<Object, Object> map);

	List<SysRole> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<SysRole> generateMyPageViewVO(Map<Object, Object> map);
}
