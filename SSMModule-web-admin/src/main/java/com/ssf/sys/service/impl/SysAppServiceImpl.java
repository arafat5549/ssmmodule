...
import com.ssf.sys.service.ISysAppService;
import com.ssf.sys.dao.SysAppDao;
...
public class SysAppServiceImpl implements ISysAppService {
	...
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|SysApp|";
	private static final Class<SysApp> SELF_CLASS = SysApp.class;

	@Resource(name = "sysAppDao")
	private SysAppDao mapper;
	...
	@Override
	public List<SysApp> selectListByMap(Map<Object, Object> map) {
	...
	@Override
	public List<SysApp> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	@Override
	public SysApp selectByPrimaryKey(Integer id) {
		String cache_key = PREFIX_CAHCE + "selectByPrimaryKey|" + id;
		if(springContextHelper.getRedisAcaliable())
		{
			SysApp result_cache = redisCache.getCache(cache_key, SELF_CLASS);
	...
	@Override
	public int insertSelective(SysApp record) {
		return mapper.insertSelective(record);
	}

	@Override
	public int updateByPrimaryKeySelective(SysApp record) {
		return mapper.updateByPrimaryKeySelective(record);
	}

	@Override
	public int updateByPrimaryKey(SysApp record) {
		return mapper.updateByPrimaryKey(record);
	}
	
	@Override
	public MyPageView<SysApp> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<SysApp> _list = mapper.selectListByMap(map);
		...
		MyPageView<SysApp> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
