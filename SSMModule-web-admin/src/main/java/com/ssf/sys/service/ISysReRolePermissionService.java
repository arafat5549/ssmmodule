 ...
 *
 */
public interface ISysReRolePermissionService {
	 ...
	 * @return
	 */
	List<SysReRolePermission> selectListByMap(Map<Object, Object> map);

	List<SysReRolePermission> listPage(int offset,int limit,Map<Object, Object> map);
	...
	int insert(SysReRolePermission record);

	int insertSelective(SysReRolePermission record);
     ...
     * @return
     */
    MyPageView<SysReRolePermission> generateMyPageViewVO(Map<Object, Object> map);
}
