 ...
 *
 */
public interface ISysReUserRoleService {
	 ...
	 * @return
	 */
	List<SysReUserRole> selectListByMap(Map<Object, Object> map);

	List<SysReUserRole> listPage(int offset,int limit,Map<Object, Object> map);
	...
	int insert(SysReUserRole record);

	int insertSelective(SysReUserRole record);
     ...
     * @return
     */
    MyPageView<SysReUserRole> generateMyPageViewVO(Map<Object, Object> map);
}
