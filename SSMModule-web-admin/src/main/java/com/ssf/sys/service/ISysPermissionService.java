...
public interface ISysPermissionService {
	 ...
	 * @return
	 */
	List<SysPermission> selectListByMap(Map<Object, Object> map);

	List<SysPermission> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<SysPermission> generateMyPageViewVO(Map<Object, Object> map);
}
