...
public class MyPageIndex implements Serializable{

	private long startindex;// 开始页码
	private long endindex;// 结束页码

	public MyPageIndex(long startindex, long endindex) {
	 ...
	 * @return
	 */
	public static MyPageIndex getPageIndex(long pagecode, int currentPage,
			long totalpage) {
		...
		return new MyPageIndex(startpage, endpage);
	}
}
