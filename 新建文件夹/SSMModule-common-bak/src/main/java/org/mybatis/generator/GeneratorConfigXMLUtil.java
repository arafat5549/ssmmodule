...
public class GeneratorConfigXMLUtil {
	...
	private static final String ORIGIN_CONFIG = "src/main/resources/generatorConfig.xml";
	...
	public static void convertXmlStrToObjectTest(String dbName,String dbType) throws SAXException, IOException, CloneNotSupportedException{
		convertXmlStrToObjectTest(dbName, dbType,OUT_CONFIG);
	}
	/**
	 * 读取数据库 生成所有table标签<p>
	 * 
	...
	public static void convertXmlStrToObjectTest(String dbName,String dbType,String out) throws SAXException, IOException, CloneNotSupportedException {
		//String xmlPath ="src/main/resources/generatorConfig.xml";
		Document document = XmlParserUtilss.getDocument(ORIGIN_CONFIG);
        ...
        writer.close();  
        System.out.println("生成Generator配置文件:"+out);
	}
