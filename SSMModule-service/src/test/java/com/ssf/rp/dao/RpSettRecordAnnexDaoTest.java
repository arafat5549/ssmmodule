...
/**
 * 
 * RpSettRecordAnnexTest DAO测试类
 *
 * @author wang
 */
public class RpSettRecordAnnexDaoTest {
    ...
    public void prepare() throws Exception {
        ...
        mapper = (RpSettRecordAnnexDao) ctx.getBean("rpSettRecordAnnexDao");
    }

	@Test
	public void selectListByMapTest() {
		List<RpSettRecordAnnex> ret = mapper.selectListByMap(null);
	...
	public void selectByPrimaryKeyTest() {
		...
		RpSettRecordAnnex ret = mapper.selectByPrimaryKey(id);
	...
	//public void insertTest() {
		//RpSettRecordAnnex record =new RpSettRecordAnnex();
		//return mapper.insert(record);
	//}

	//@Test
	//public void insertSelectiveTest() {
	    //RpSettRecordAnnex record
