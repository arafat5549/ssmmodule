...
public class OrderItemServiceImpl implements IOrderItemService {
	...
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|OrderItem|";
	private static final Class<OrderItem> SELF_CLASS = OrderItem.class;
	...
	@Override
	public List<OrderItem> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	public OrderItem selectByPrimaryKey(Long id) {
		...
		if(springContextHelper.getRedisAcaliable())
		{
			OrderItem result_cache = redisCache.getCache(cache_key, SELF_CLASS);
