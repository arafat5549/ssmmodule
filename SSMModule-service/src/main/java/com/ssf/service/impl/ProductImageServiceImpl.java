...
public class ProductImageServiceImpl implements IProductImageService {
	...
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|ProductImage|";
	private static final Class<ProductImage> SELF_CLASS = ProductImage.class;
	...
	@Override
	public List<ProductImage> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	public ProductImage selectByPrimaryKey(Long id) {
		...
		if(springContextHelper.getRedisAcaliable())
		{
			ProductImage result_cache = redisCache.getCache(cache_key, SELF_CLASS);
