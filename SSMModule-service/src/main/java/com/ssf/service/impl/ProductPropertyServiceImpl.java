...
public class ProductPropertyServiceImpl implements IProductPropertyService {
	...
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|ProductProperty|";
	private static final Class<ProductProperty> SELF_CLASS = ProductProperty.class;
	...
	@Override
	public List<ProductProperty> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	public ProductProperty selectByPrimaryKey(Long id) {
		...
		if(springContextHelper.getRedisAcaliable())
		{
			ProductProperty result_cache = redisCache.getCache(cache_key, SELF_CLASS);
