...
public class PmsPermissionServiceImpl implements IPmsPermissionService {
	...
	@Override
	public MyPageView<PmsPermission> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<PmsPermission> _list = mapper.selectListByMap(map);
		...
		MyPageView<PmsPermission> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
