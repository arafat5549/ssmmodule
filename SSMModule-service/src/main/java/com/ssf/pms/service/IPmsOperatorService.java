 ...
 *
 */
public interface IPmsOperatorService {
	 ...
	 * @return
	 */
	List<PmsOperator> selectListByMap(Map<Object, Object> map);

	List<PmsOperator> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<PmsOperator> generateMyPageViewVO(Map<Object, Object> map);
}
