...
public class PmsOperatorServiceImpl implements IPmsOperatorService {
	...
	@Override
	public MyPageView<PmsOperator> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<PmsOperator> _list = mapper.selectListByMap(map);
		...
		MyPageView<PmsOperator> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
