 ...
 *
 */
public interface IPmsRolePermissionService {
	 ...
	 * @return
	 */
	List<PmsRolePermission> selectListByMap(Map<Object, Object> map);

	List<PmsRolePermission> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<PmsRolePermission> generateMyPageViewVO(Map<Object, Object> map);
}
