 ...
 *
 */
public interface IPmsMenuService {
	 ...
	 * @return
	 */
	List<PmsMenu> selectListByMap(Map<Object, Object> map);

	List<PmsMenu> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<PmsMenu> generateMyPageViewVO(Map<Object, Object> map);
}
