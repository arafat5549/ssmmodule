 ...
 *
 */
public interface IPmsPermissionService {
	 ...
	 * @return
	 */
	List<PmsPermission> selectListByMap(Map<Object, Object> map);

	List<PmsPermission> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<PmsPermission> generateMyPageViewVO(Map<Object, Object> map);
}
