 ...
 *
 */
public interface IPmsOperatorLogService {
	 ...
	 * @return
	 */
	List<PmsOperatorLog> selectListByMap(Map<Object, Object> map);

	List<PmsOperatorLog> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<PmsOperatorLog> generateMyPageViewVO(Map<Object, Object> map);
}
