...
public class PmsRolePermissionServiceImpl implements IPmsRolePermissionService {
	...
	@Override
	public MyPageView<PmsRolePermission> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<PmsRolePermission> _list = mapper.selectListByMap(map);
		...
		MyPageView<PmsRolePermission> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
