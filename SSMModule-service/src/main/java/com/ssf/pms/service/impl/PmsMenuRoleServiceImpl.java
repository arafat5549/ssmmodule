...
import com.ssf.pms.service.IPmsMenuRoleService;
...
/**
 * 
 * IPmsMenuRoleService 接口实现类
 *
 * @author wang
 */
@Service(value = "pmsMenuRoleService")
public class PmsMenuRoleServiceImpl implements IPmsMenuRoleService {

	private static final Logger LOG = LoggerFactory.getLogger(PmsMenuRoleServiceImpl.class);
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|PmsMenuRole|";
	private static final Class<PmsMenuRole> SELF_CLASS = PmsMenuRole.class;

	@Resource(name = "pmsMenuRoleDao")
	...
	@Override
	public List<PmsMenuRole> selectListByMap(Map<Object, Object> map) {
	...
	@Override
	public List<PmsMenuRole> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	@Override
	public PmsMenuRole selectByPrimaryKey(Long id) {
		String cache_key = PREFIX_CAHCE + "selectByPrimaryKey|" + id;
		if(springContextHelper.getRedisAcaliable())
		{
			PmsMenuRole result_cache = redisCache.getCache(cache_key, SELF_CLASS);
	...
	@Override
	public int insert(PmsMenuRole record) {
		return mapper.insert(record);
	}

	@Override
	public int insertSelective(PmsMenuRole record) {
		return mapper.insertSelective(record);
	}

	@Override
	public int updateByPrimaryKeySelective(PmsMenuRole record) {
		return mapper.updateByPrimaryKeySelective(record);
	}

	@Override
	public int updateByPrimaryKey(PmsMenuRole record) {
		return mapper.updateByPrimaryKey(record);
	}
	
	@Override
	public MyPageView<PmsMenuRole> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<PmsMenuRole> _list = mapper.selectListByMap(map);
		...
		MyPageView<PmsMenuRole> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
