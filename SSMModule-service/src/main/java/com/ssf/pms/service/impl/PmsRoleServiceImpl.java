...
import com.ssf.pms.service.IPmsRoleService;
...
/**
 * 
 * IPmsRoleService 接口实现类
 *
 * @author wang
 */
@Service(value = "pmsRoleService")
public class PmsRoleServiceImpl implements IPmsRoleService {

	private static final Logger LOG = LoggerFactory.getLogger(PmsRoleServiceImpl.class);
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|PmsRole|";
	private static final Class<PmsRole> SELF_CLASS = PmsRole.class;

	@Resource(name = "pmsRoleDao")
	...
	@Override
	public List<PmsRole> selectListByMap(Map<Object, Object> map) {
	...
	@Override
	public List<PmsRole> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	@Override
	public PmsRole selectByPrimaryKey(Long id) {
		String cache_key = PREFIX_CAHCE + "selectByPrimaryKey|" + id;
		if(springContextHelper.getRedisAcaliable())
		{
			PmsRole result_cache = redisCache.getCache(cache_key, SELF_CLASS);
	...
	@Override
	public int insert(PmsRole record) {
		return mapper.insert(record);
	}

	@Override
	public int insertSelective(PmsRole record) {
		return mapper.insertSelective(record);
	}

	@Override
	public int updateByPrimaryKeySelective(PmsRole record) {
		return mapper.updateByPrimaryKeySelective(record);
	}

	@Override
	public int updateByPrimaryKey(PmsRole record) {
		return mapper.updateByPrimaryKey(record);
	}
	
	@Override
	public MyPageView<PmsRole> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<PmsRole> _list = mapper.selectListByMap(map);
		...
		MyPageView<PmsRole> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
