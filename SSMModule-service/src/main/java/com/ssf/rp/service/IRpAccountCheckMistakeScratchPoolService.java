 ...
 *
 */
public interface IRpAccountCheckMistakeScratchPoolService {
	 ...
	 * @return
	 */
	List<RpAccountCheckMistakeScratchPool> selectListByMap(Map<Object, Object> map);

	List<RpAccountCheckMistakeScratchPool> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpAccountCheckMistakeScratchPool> generateMyPageViewVO(Map<Object, Object> map);
}
