 ...
 *
 */
public interface IRpSettDailyCollectService {
	 ...
	 * @return
	 */
	List<RpSettDailyCollect> selectListByMap(Map<Object, Object> map);

	List<RpSettDailyCollect> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpSettDailyCollect> generateMyPageViewVO(Map<Object, Object> map);
}
