 ...
 *
 */
public interface IRpUserPayConfigService {
	 ...
	 * @return
	 */
	List<RpUserPayConfig> selectListByMap(Map<Object, Object> map);

	List<RpUserPayConfig> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpUserPayConfig> generateMyPageViewVO(Map<Object, Object> map);
}
