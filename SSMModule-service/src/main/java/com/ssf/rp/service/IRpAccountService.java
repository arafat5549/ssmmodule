...
public interface IRpAccountService {
	 ...
	 * @return
	 */
	List<RpAccount> selectListByMap(Map<Object, Object> map);

	List<RpAccount> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpAccount> generateMyPageViewVO(Map<Object, Object> map);
}
