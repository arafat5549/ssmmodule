 ...
 *
 */
public interface IRpPayProductService {
	 ...
	 * @return
	 */
	List<RpPayProduct> selectListByMap(Map<Object, Object> map);

	List<RpPayProduct> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpPayProduct> generateMyPageViewVO(Map<Object, Object> map);
}
