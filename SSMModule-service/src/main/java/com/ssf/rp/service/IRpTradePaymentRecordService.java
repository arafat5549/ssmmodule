 ...
 *
 */
public interface IRpTradePaymentRecordService {
	 ...
	 * @return
	 */
	List<RpTradePaymentRecord> selectListByMap(Map<Object, Object> map);

	List<RpTradePaymentRecord> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpTradePaymentRecord> generateMyPageViewVO(Map<Object, Object> map);
}
