...
public class RpNotifyRecordLogServiceImpl implements IRpNotifyRecordLogService {
	...
	@Override
	public MyPageView<RpNotifyRecordLog> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpNotifyRecordLog> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpNotifyRecordLog> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
