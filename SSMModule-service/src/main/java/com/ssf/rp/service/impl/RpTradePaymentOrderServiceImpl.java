...
public class RpTradePaymentOrderServiceImpl implements IRpTradePaymentOrderService {
	...
	@Override
	public MyPageView<RpTradePaymentOrder> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpTradePaymentOrder> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpTradePaymentOrder> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
