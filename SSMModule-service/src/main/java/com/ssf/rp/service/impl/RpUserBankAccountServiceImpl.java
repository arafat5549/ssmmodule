...
public class RpUserBankAccountServiceImpl implements IRpUserBankAccountService {
	...
	@Override
	public MyPageView<RpUserBankAccount> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpUserBankAccount> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpUserBankAccount> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
