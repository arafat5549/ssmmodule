 ...
 *
 */
public interface IRpAccountCheckMistakeService {
	 ...
	 * @return
	 */
	List<RpAccountCheckMistake> selectListByMap(Map<Object, Object> map);

	List<RpAccountCheckMistake> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpAccountCheckMistake> generateMyPageViewVO(Map<Object, Object> map);
}
