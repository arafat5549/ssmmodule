 ...
 *
 */
public interface IRpAccountCheckBatchService {
	 ...
	 * @return
	 */
	List<RpAccountCheckBatch> selectListByMap(Map<Object, Object> map);

	List<RpAccountCheckBatch> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpAccountCheckBatch> generateMyPageViewVO(Map<Object, Object> map);
}
