...
public class RpSettRecordAnnexServiceImpl implements IRpSettRecordAnnexService {
	...
	@Override
	public MyPageView<RpSettRecordAnnex> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpSettRecordAnnex> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpSettRecordAnnex> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
