 ...
 *
 */
public interface IRpNotifyRecordService {
	 ...
	 * @return
	 */
	List<RpNotifyRecord> selectListByMap(Map<Object, Object> map);

	List<RpNotifyRecord> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpNotifyRecord> generateMyPageViewVO(Map<Object, Object> map);
}
