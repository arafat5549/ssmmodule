...
public class RpAccountHistoryServiceImpl implements IRpAccountHistoryService {
	...
	@Override
	public MyPageView<RpAccountHistory> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpAccountHistory> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpAccountHistory> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
