 ...
 *
 */
public interface IRpPayWayService {
	 ...
	 * @return
	 */
	List<RpPayWay> selectListByMap(Map<Object, Object> map);

	List<RpPayWay> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpPayWay> generateMyPageViewVO(Map<Object, Object> map);
}
