 ...
 *
 */
public interface IRpSettRecordService {
	 ...
	 * @return
	 */
	List<RpSettRecord> selectListByMap(Map<Object, Object> map);

	List<RpSettRecord> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpSettRecord> generateMyPageViewVO(Map<Object, Object> map);
}
