 ...
 *
 */
public interface IRpUserBankAccountService {
	 ...
	 * @return
	 */
	List<RpUserBankAccount> selectListByMap(Map<Object, Object> map);

	List<RpUserBankAccount> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpUserBankAccount> generateMyPageViewVO(Map<Object, Object> map);
}
