 ...
 *
 */
public interface IRpUserPayInfoService {
	 ...
	 * @return
	 */
	List<RpUserPayInfo> selectListByMap(Map<Object, Object> map);

	List<RpUserPayInfo> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpUserPayInfo> generateMyPageViewVO(Map<Object, Object> map);
}
