...
public class RpAccountCheckMistakeServiceImpl implements IRpAccountCheckMistakeService {
	...
	@Override
	public MyPageView<RpAccountCheckMistake> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpAccountCheckMistake> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpAccountCheckMistake> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
