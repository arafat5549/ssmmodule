 ...
 *
 */
public interface IRpAccountHistoryService {
	 ...
	 * @return
	 */
	List<RpAccountHistory> selectListByMap(Map<Object, Object> map);

	List<RpAccountHistory> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpAccountHistory> generateMyPageViewVO(Map<Object, Object> map);
}
