 ...
 *
 */
public interface IRpNotifyRecordLogService {
	 ...
	 * @return
	 */
	List<RpNotifyRecordLog> selectListByMap(Map<Object, Object> map);

	List<RpNotifyRecordLog> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpNotifyRecordLog> generateMyPageViewVO(Map<Object, Object> map);
}
