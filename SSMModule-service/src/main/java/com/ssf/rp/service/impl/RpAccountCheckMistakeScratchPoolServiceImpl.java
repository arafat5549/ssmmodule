...
public class RpAccountCheckMistakeScratchPoolServiceImpl implements IRpAccountCheckMistakeScratchPoolService {
	...
	@Override
	public MyPageView<RpAccountCheckMistakeScratchPool> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpAccountCheckMistakeScratchPool> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpAccountCheckMistakeScratchPool> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
