 ...
 *
 */
public interface IRpRefundRecordService {
	 ...
	 * @return
	 */
	List<RpRefundRecord> selectListByMap(Map<Object, Object> map);

	List<RpRefundRecord> listPage(int offset,int limit,Map<Object, Object> map);
