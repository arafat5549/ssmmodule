...
public class RpUserPayInfoServiceImpl implements IRpUserPayInfoService {
	...
	@Override
	public MyPageView<RpUserPayInfo> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<RpUserPayInfo> _list = mapper.selectListByMap(map);
		...
		MyPageView<RpUserPayInfo> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
