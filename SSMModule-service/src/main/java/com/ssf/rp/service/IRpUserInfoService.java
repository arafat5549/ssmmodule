 ...
 *
 */
public interface IRpUserInfoService {
	 ...
	 * @return
	 */
	List<RpUserInfo> selectListByMap(Map<Object, Object> map);

	List<RpUserInfo> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpUserInfo> generateMyPageViewVO(Map<Object, Object> map);
}
