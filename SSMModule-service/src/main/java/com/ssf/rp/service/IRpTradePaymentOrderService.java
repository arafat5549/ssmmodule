 ...
 *
 */
public interface IRpTradePaymentOrderService {
	 ...
	 * @return
	 */
	List<RpTradePaymentOrder> selectListByMap(Map<Object, Object> map);

	List<RpTradePaymentOrder> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<RpTradePaymentOrder> generateMyPageViewVO(Map<Object, Object> map);
}
