...
import com.ssf.rp.service.IRpSettDailyCollectService;
 ...
 * @author wang
 */
@Service(value = "rpSettDailyCollectService")
public class RpSettDailyCollectServiceImpl implements IRpSettDailyCollectService {

	private static final Logger LOG = LoggerFactory.getLogger(RpSettDailyCollectServiceImpl.class);
	private static final String PREFIX_CAHCE = RedisCache.CAHCENAME + "|RpSettDailyCollect|";
	private static final Class<RpSettDailyCollect> SELF_CLASS = RpSettDailyCollect.class;

	@Resource(name = "rpSettDailyCollectDao")
	...
	@Override
	public List<RpSettDailyCollect> selectListByMap(Map<Object, Object> map) {
	...
	@Override
	public List<RpSettDailyCollect> listPage(int offset,int limit,Map<Object, Object> map)
	{
	...
	@Override
	public RpSettDailyCollect selectByPrimaryKey(String id) {
		String cache_key = PREFIX_CAHCE + "selectByPrimaryKey|" + id;
		if(springContextHelper.getRedisAcaliable())
		{
			RpSettDailyCollect result_cache = redisCache.getCache(cache_key, SELF_CLASS);
	...
	@Override
	public int insert(RpSettDailyCollect record) {
		return mapper.insert(record);
	}

	@Override
	public int insertSelective(RpSettDailyCollect record) {
		return mapper.insertSelective(record);
	}

	@Override
	public int updateByPrimaryKeySelective(RpSettDailyCollect record) {
