 ...
 *
 */
public interface ISysProductPropertyService {
	 ...
	 * @return
	 */
	List<SysProductProperty> selectListByMap(Map<Object, Object> map);

	List<SysProductProperty> listPage(int offset,int limit,Map<Object, Object> map);
	...
	int insert(SysProductProperty record);

	int insertSelective(SysProductProperty record);
     ...
     * @return
     */
    MyPageView<SysProductProperty> generateMyPageViewVO(Map<Object, Object> map);
}
