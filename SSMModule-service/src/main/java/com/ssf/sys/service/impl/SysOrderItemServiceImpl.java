...
public class SysOrderItemServiceImpl implements ISysOrderItemService {
	...
	@Override
	public MyPageView<SysOrderItem> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<SysOrderItem> _list = mapper.selectListByMap(map);
		...
		MyPageView<SysOrderItem> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
