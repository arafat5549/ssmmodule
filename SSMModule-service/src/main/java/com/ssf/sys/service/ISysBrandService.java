 ...
 *
 */
public interface ISysBrandService {
	 ...
	 * @return
	 */
	List<SysBrand> selectListByMap(Map<Object, Object> map);

	List<SysBrand> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<SysBrand> generateMyPageViewVO(Map<Object, Object> map);
}
