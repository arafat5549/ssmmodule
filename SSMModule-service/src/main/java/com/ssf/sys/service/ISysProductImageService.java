...
public interface ISysProductImageService {
	 ...
	 * @return
	 */
	List<SysProductImage> selectListByMap(Map<Object, Object> map);

	List<SysProductImage> listPage(int offset,int limit,Map<Object, Object> map);
	...
	int insert(SysProductImage record);

	int insertSelective(SysProductImage record);
     ...
     * @return
     */
    MyPageView<SysProductImage> generateMyPageViewVO(Map<Object, Object> map);
}
