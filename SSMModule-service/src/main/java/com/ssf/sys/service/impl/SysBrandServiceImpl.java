...
public class SysBrandServiceImpl implements ISysBrandService {
	...
	@Override
	public MyPageView<SysBrand> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<SysBrand> _list = mapper.selectListByMap(map);
		...
		MyPageView<SysBrand> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
