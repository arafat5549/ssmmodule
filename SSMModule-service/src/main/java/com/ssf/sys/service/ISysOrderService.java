...
public interface ISysOrderService {
	 ...
	 * @return
	 */
	List<SysOrder> selectListByMap(Map<Object, Object> map);

	List<SysOrder> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<SysOrder> generateMyPageViewVO(Map<Object, Object> map);
}
