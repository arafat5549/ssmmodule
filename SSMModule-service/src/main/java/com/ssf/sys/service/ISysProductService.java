...
public interface ISysProductService {
	 ...
	 * @return
	 */
	List<SysProduct> selectListByMap(Map<Object, Object> map);

	List<SysProduct> listPage(int offset,int limit,Map<Object, Object> map);
     ...
     * @return
     */
    MyPageView<SysProduct> generateMyPageViewVO(Map<Object, Object> map);
}
