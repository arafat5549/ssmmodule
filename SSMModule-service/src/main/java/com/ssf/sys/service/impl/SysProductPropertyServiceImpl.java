...
public class SysProductPropertyServiceImpl implements ISysProductPropertyService {
	...
	@Override
	public MyPageView<SysProductProperty> generateMyPageViewVO(Map<Object, Object> map) {
		
		int _totalCount = mapper.selectCountByMap(map);
		
		List<SysProductProperty> _list = mapper.selectListByMap(map);
		...
		MyPageView<SysProductProperty> pageView = MyPageView.generaterMyPageView(recordPerPage, currentPage, _totalCount, _list);
